...
export declare class RpcContextCreator {
    ...
    create<T extends ParamsMetadata = ParamsMetadata>(instance: Controller, callback: (...args: unknown[]) => Observable<any>, module: string, methodName: string, contextId?: import("@nestjs/core").ContextId, inquirerId?: string): (...args: any[]) => Promise<Observable<any>>;
    ...
    getMetadata<T>(instance: Controller, methodName: string): RpcHandlerMetadata;
