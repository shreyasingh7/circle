...
class RpcContextCreator {
    ...
    create(instance, callback, module, methodName, contextId = constants_3.STATIC_CONTEXT, inquirerId) {
        const contextType = 'rpc';
        const { argsLength, paramtypes, getParamsMetadata } = this.getMetadata(instance, methodName);
    ...
    getMetadata(instance, methodName) {
        const cacheMetadata = this.handlerMetadataStorage.get(instance, methodName);
        if (cacheMetadata) {
            return cacheMetadata;
        }
        const metadata = this.contextUtils.reflectCallbackMetadata(instance, methodName, constants_4.PARAM_ARGS_METADATA) || rpc_metadata_constants_1.DEFAULT_CALLBACK_METADATA;
